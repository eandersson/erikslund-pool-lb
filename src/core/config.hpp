...
struct HealthConfig {
    ...
    int connect_timeout_milliseconds = 3'000;
    int rise_checks = 1;
    int fall_checks = 3;
};
...
struct LimitsConfig {
    ...
    std::size_t max_connections_per_ip = 1'024;
    double connections_per_second_per_ip = 16.0;
    std::size_t connection_burst_per_ip = 512;
    ...
    double messages_per_second_per_connection = 1'024.0;
    std::size_t message_burst_per_connection = 2'048;
    double bytes_per_second_per_connection = 262'144.0;
    std::size_t byte_burst_per_connection = 524'288;
    double messages_per_second_per_ip = 32'768.0;
    std::size_t message_burst_per_ip = 65'536;
    double bytes_per_second_per_ip = 4'194'304.0;
    std::size_t byte_burst_per_ip = 16'777'216;
    std::size_t max_messages_per_ready_event = 2'048;
    ...
    int first_message_timeout_seconds = 15;
    int upstream_connect_timeout_milliseconds = 15'000;
...
struct ProtocolConfig {
    bool allow_unknown_mining_methods = true;
